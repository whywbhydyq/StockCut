...
assert.ok(sheetTool.includes('Web Worker'), 'sheet worker progress UI exists');
...
assert.ok(linearTool.includes('Web Worker'), 'linear worker progress UI exists');
...
assert.ok(fs.existsSync('src/core/worker/optimizerWorkerClient.ts'), 'worker progress/cancel client exists');
