...
export const pages: SeoPage[] = [
  { slug: '/', title: 'Free Sheet Cutting Optimizer with Kerf', description: 'Turn plywood, MDF, acrylic, and other rectangular stock into printable cut layouts with kerf, labels, yield, waste, and offcuts.', kind: 'sheet', preset: 'imperial-sheet' },
  { slug: '/sheet-cutting-optimizer', title: 'Sheet Cutting Optimizer', description: 'A kerf-aware 2D sheet cutting optimizer for rectangular plywood, MDF, melamine, acrylic, and sheet stock projects.', kind: 'sheet', preset: 'imperial-sheet' },
  { slug: '/linear-cutting-optimizer', title: 'Linear Cutting Optimizer', description: 'Optimize lumber, steel tube, aluminum extrusion, PVC pipe, and other stock lengths with kerf and printable cut sequences.', kind: 'linear', preset: 'imperial-linear' },
  { slug: '/saw-kerf-calculator', title: 'Saw Kerf Calculator', description: 'Calculate blade kerf loss and understand why exact-fit cuts often fail once saw width is included.', kind: 'kerf' },
  ...
  { slug: '/4x8-plywood-cut-list-optimizer', title: '4×8 Plywood Cut List Optimizer', description: 'Optimize a 48 × 96 inch plywood sheet with fractional inch dimensions and 1/8 inch saw kerf.', kind: 'sheet', preset: 'plywood-4x8' },
  ...
  { slug: '/steel-tube-cutting-optimizer', title: 'Steel Tube Cutting Optimizer', description: 'Optimize steel tube cuts from standard stock lengths with kerf, offcut, and cut sequence output.', kind: 'linear', preset: 'steel-tube' },
