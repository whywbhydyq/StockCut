...
function sheetProject(
  ...
  return {
    ...
    stock: { id: `${id}-stock`, label: material, width, height, quantity: 'auto', trimTop: '0', trimRight: '0', trimBottom: '0', trimLeft: '0', material, cost: '', grainDirection: 'none' },
    parts
  };
}
...
function linearProject(
  ...
  return {
    ...
    kerf,
    strategy: 'least_waste',
    stock: { id: `${id}-stock`, label: material, length, quantity: 'auto', trimStart: '0', trimEnd: '0', material, cost: '' },
    parts
  };
}
