  ...
  return (
    <section className="tool-card mt-4" aria-label="Evidence, scope, and verification notes">
      <div className="grid gap-4 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.18em] text-stock-muted">Evidence and limits</p>
          ...
          <p className="mt-3 rounded-2xl border border-stock-line bg-white p-3 text-sm leading-6 text-stock-muted"><strong className="text-stock-ink">Source of truth:</strong> {evidence.sourceOfTruth}</p>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-stock-line bg-stock-paper p-4 md:col-span-2">
            <h3 className="font-black text-stock-ink">Useful citation summary</h3>
