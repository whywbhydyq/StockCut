  ...
  return <main className="mx-auto max-w-7xl px-4 py-8">
    ...
    <section className="tool-card mt-4" aria-label="StockCut tool FAQ">
      ...
      <div className="mt-3 grid gap-3 md:grid-cols-3">
        <details className="rounded-xl border border-stock-line bg-stock-paper p-3"><summary className="cursor-pointer font-bold text-stock-ink">Does StockCut upload my cut list?</summary><p className="mt-2 text-sm text-stock-muted">No. StockCut calculates and autosaves in your browser and does not cloud-save cut lists.</p></details>
        <details className="rounded-xl border border-stock-line bg-stock-paper p-3"><summary className="cursor-pointer font-bold text-stock-ink">Does StockCut guarantee a mathematically optimal layout?</summary><p className="mt-2 text-sm text-stock-muted">No. It creates practical kerf-aware layouts for planning and printing; verify before cutting.</p></details>
        <details className="rounded-xl border border-stock-line bg-stock-paper p-3"><summary className="cursor-pointer font-bold text-stock-ink">Can I print or save a PDF?</summary><p className="mt-2 text-sm text-stock-muted">Yes. Use the print button and choose Save as PDF in your browser.</p></details>
      </div>
    </section>
  </main>;
}
